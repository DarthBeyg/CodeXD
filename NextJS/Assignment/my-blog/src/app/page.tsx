...
export default function Home() { 
    return (
      <div className={`${font.className} bg-[rgba(181,180,177,1)] min-h-screen text-2xl`}> 
        <header className=" p-4 flex flex-row justify-between items-center">
          <button className="hover:font-extrabold text-3xl text-black motion-preset-slide-right motion-duration-500 motion-delay-500">Volk's Personal Blog </button>
          <div className="flex space-x-4"> {/* Added flex container */}
          <button className="hover:font-bold text-black text-3xl font-medium py-2 px-4 rounded-md motion-preset-compress motion-delay-100 motion-duration-500">Tech Blogs</button>
          <button className="hover:font-bold text-black text-3xl font-medium py-2 px-4 rounded-md motion-preset-compress motion-delay-150 motion-duration-500">Traveling Blogs</button>
          <button className="hover:font-bold text-black text-3xl font-medium py-2 px-4 rounded-md motion-preset-compress motion-delay-200 motion-duration-500">Financial Blogs</button>
          </div>
        </header>   
          ...
          <section className="mb-8 text-[rgb(255,255,255)]">    
            <div className="flex items-start mb-4">
              ...
              <div className="flex flex-col items-end"> {/* Added flex column container */}
                <Image src='/pfp/1.jpg' alt="Profile Picture" width={450} height={450} className="rounded-full motion-preset-bounce motion-duration-750 motion-delay-500" />
                <div className="flex flex-row gap-8 mt-8 mx-20"> {/* New container for logos */}
                  <Image src={C} alt="logo" width={50} height={50} className='motion-preset-oscillate motion-duration-500 motion-delay-75'/> 
                  <Image src={Python} alt="logo" width={50} height={50} className='motion-preset-oscillate motion-duration-500 motion-delay-125'/>
                  <Image src={Nextjs} alt="logo" width={50} height={50} className='motion-preset-oscillate motion-duration-500 motion-delay-150'/>
                  <Image src={ReactIcon} alt="logo" width={50} height={50} className='motion-preset-oscillate motion-duration-500 motion-delay-175'/>
                </div>
                <div className="flex flex-row gap-8 mt-10 mx-20"> {/* New container for logos */}
                  <Image src={Node} alt="logo" width={50} height={50} className='motion-preset-oscillate motion-duration-500 motion-delay-225'/> 
                  <Image src={TailwindL} alt="logo" width={50} height={50} className='motion-preset-oscillate motion-duration-500 motion-delay-100'/>
                  <Image src={TypescriptL} alt="logo" width={50} height={50} className='motion-preset-oscillate motion-duration-500 motion-delay-50'/>
                  <Image src={Logo} alt="logo" width={50} height={50} className='motion-preset-oscillate motion-duration-500 motion-delay-300'/>
                </div>
              </div>                           
            </div>                                  
            <p className='w-2/3 text-white motion-preset-pop motion-duration-500 motion-delay-200'>Ready for some unique perspective? Let's explore where technology meets money then embraces 
               wanderlust! 🚀</p>            
          </section>
          <section>
